...
import { adminGlobalStyles } from '../../components/Admin/ui'
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-4">
              <button
                ...
                className="lg:hidden text-white hover:text-[#55DDB5] transition-colors"
              >
            ...
            <div className="flex items-center gap-4">
              <button className="relative text-white/50 hover:text-[#55DDB5] transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-[#2AACB2] to-[#0B74C1] flex items-center justify-center shadow-lg">
                  <span className="text-white font-bold text-sm">AD</span>
                </div>
              </div>
            </div>
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl border transition-all ${
                    isActive(item.path)
                      ? 'bg-[#2AACB2]/15 text-[#55DDB5] border-[#2AACB2]/30 shadow-[inset_2px_0_0_0_#55DDB5]'
                      : 'text-white/70 border-transparent hover:bg-white/10 hover:text-white hover:border-white/10'
                  }`}
                >
