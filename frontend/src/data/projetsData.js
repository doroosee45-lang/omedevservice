...
export const projetsData = [
  {
    ...
    descriptionLongue: "L’hôtel Méridien souffrait de coupures réseau et d’une couverture WiFi inégale. OMEDEV a installé 24 points d’accès Ubiquiti, un routage VLAN, et une liaison fibre optique redondante. Résultat : débit monté à 1 Gbps, roaming parfait, satisfaction client +95%.",
    technologies: ["Ubiquiti", "Fibre optique", "VLAN", "WiFi 6", "pfSense"],
    client: {
      nom: "Hôtel Méridien",
      logo: "https://via.placeholder.com/80?text=Meridien",
      temoignage: "OMEDEV a transformé notre réseau. Plus aucune plainte client, et l’équipe technique est réactive.",
  ...
  },
  {
    ...
    descriptionLongue: "La Banque Atlantique a fait appel à OMEDEV pour sécuriser son système de transactions en ligne. Nous avons réalisé un audit externe/interne, corrigé 12 vulnérabilités critiques, et installé un cluster de firewalls Fortinet avec IPS/IDS. Aucune intrusion depuis 6 mois.",
  ...
  },
  {
    ...
    client: {
      nom: "Mode & Co",
      temoignage: "Notre boutique en ligne explose grâce à l’expertise d’OMEDEV. Interface fluide et support impeccable.",
      clientNom: "Sophie L.",
  ...
  },
  {
    ...
    descriptionLongue: "Green Tower souhaitait réduire sa facture énergétique. OMEDEV a réalisé un audit solaire, installé des panneaux monocristallins 400Wc et un système de monitoring. Économie annuelle : 35% sur l’électricité.",
    technologies: ["Panneaux solaires", "Onduleurs Huawei", "Monitoring IoT", "Batteries Lithium"],
    client: {
      nom: "Green Tower",
      temoignage: "Un projet mené de A à Z, dans les délais et le budget. L’équipe OMEDEV est très compétente.",
      clientNom: "Koffi A.",
      clientPoste: "Gérant",
      note: 5,
